        ...
        <div class="container">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar"><li class="nav-item dropdown open"><a class="nav-link link" href="https://mobirise.com/" aria-expanded="true"></a></li></ul>
...
<section class="engine"><a rel="external" href="https://mobirise.com">top wysiwyg web builder</a></section><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-after-navbar" id="header1-2" style="background-image: url({{ asset('landing-assets/images/1a6cafd3a0a79e60e39b6bdff215dd67-2000x1250-41.jpg') }});">
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1">AirMate</h1>
                    <p class="mbr-section-lead lead"><br><span style="font-size: 46px; line-height: 1.5;">AirMate helps you find new friends while waiting for your flights in the airport</span><br></p>
                    <div class="mbr-section-btn"><a class="btn btn-lg btn-primary" href="{{ route('social-login', ['provider' => 'facebook']) }}"><span class="socicon socicon-facebook mbr-iconfont mbr-iconfont-btn" style="font-size: 23px;"></span>Login with Facebook</a> </div>
                </div>
            </div>
        </div>
    </div>
